...
export const CrowdCanvas = ({ src, rows = 15, cols = 7 }: CrowdCanvasProps) => {
  ...
  return (
    <canvas ref={canvasRef} className="absolute bottom-0 h-full w-full opacity-60 mix-blend-multiply" />
  );
};
...
export const Skiper39 = () => {
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 grid content-start justify-items-center gap-6 text-center text-black z-10">
